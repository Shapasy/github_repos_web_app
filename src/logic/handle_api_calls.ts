...
export async function get_one_month_ago_repos(page_index: number) {
    ...
    const url = `${REACT_APP_API_URL}/search/repositories?q=created:>${date_one_month_age}&page=${page_index}&per_page=${REACT_APP_NUMBER_OF_REPOS_PER_PAGE}&sort=stars&order=desc`
